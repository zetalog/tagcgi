...
#define GCGI_VERSION	"0.9.5"

static const char gcgi_ident[] =
    "$GCGI: GCGI " GCGI_VERSION " Copyright (C) 2001-2002 Julian Catchen $\n"
...
findQueryStringColl(char *field, int *index)
{
	...
	*index = -1;
    ...
    for (*index = 0; qsc && *index < cgiQuery->queryCount; (*index)++) {
